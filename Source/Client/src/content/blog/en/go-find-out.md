---
title: "Go Find Out: Get Out of the Chair"
excerpt: "Most disagreements in a project aren't disagreements at all — they're two people guessing about something neither has checked. The cheapest tool in the manifesto is also the one we use least: get up and go find out."
publishedAt: "2026-05-07"
readingTime: 5
tags: ["Leadership", "Research", "Team Collaboration", "Push Manifesto", "Product", "Communication"]
author:
  name: "Michael Wise"
...
category: "Leadership"
status: "published"
coverImage: "/blog/covers/go-find-out.jpg"
...
We default to assuming because assuming is fast and free in the moment. Walking over to the support team, reading the actual logs, ringing the customer, opening the file — all of that has a small upfront cost. So we skip it, and we pay later, when the assumption turns out wrong and the work built on it has to be unwound.
...
> Engage. Engage early, and enough — even if to make friends. Get out of the chair and go find out.

## Make friends before you need them

The "even if to make friends" clause is the part people skip, and it's the most strategic. The time to build a relationship with the team that owns the database, the ops person who knows where the bodies are buried, the stakeholder who can quietly kill your project — is _before_ you need anything from them.
...
There's a quiet snobbery worth borrowing from historians: prefer primary sources. Don't ask someone what the customer thinks — talk to the customer. Don't infer what the system does from the documentation — read the code, watch the trace. Every hop away from the source is a chance for the signal to degrade into someone else's interpretation.
